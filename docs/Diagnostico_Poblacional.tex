...
\begin{figure}
\centering
\includegraphics{Diagnostico_Poblacional_files/figure-latex/Pop-fig-1.pdf}
...
{\centering \includegraphics[width=0.8\linewidth]{Diagnostico_Poblacional_files/figure-latex/nice-fig-1} 
